...
export default function ThreeBackground() {
    ...
    if (!mounted) {
        return (
            <div className="w-full h-[250px] md:h-[300px] flex items-center justify-center bg-gradient-to-br from-indigo-50/80 via-purple-50/80 to-blue-50/80 dark:from-indigo-950/40 dark:via-purple-950/40 dark:to-blue-950/40 rounded-xl animate-pulse" />
        );
    }
